...
1. **Obiettivi / trofei** — checklist run (max 3) + popup + Trofei account (design claude-mem #4); in PR
2. **Competitive bets — B3 share card** — vedi [competitive-bets](docs/superpowers/specs/2026-08-08-competitive-bets-design.md)
3. **Ads stub (rails + end banner)** — [plan](docs/superpowers/plans/2026-08-08-ads-stub.md) · [spec](docs/superpowers/specs/2026-08-08-ads-stub-design.md) (segnaposto; rete dopo). Landing mid/footer stub on door.
