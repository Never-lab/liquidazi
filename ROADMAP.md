...
1. **Competitive bets — B2 first-win** — checklist coach + toast (design in claude-mem #1); B1 landing already on branch
2. **Ads stub (rails + end banner)** — [plan](docs/superpowers/plans/2026-08-08-ads-stub.md) · [spec](docs/superpowers/specs/2026-08-08-ads-stub-design.md) (segnaposto; rete dopo). Landing mid/footer stub on door.
...
7. **Competitive bets — B3 share card** — dopo B2; vedi [competitive-bets](docs/superpowers/specs/2026-08-08-competitive-bets-design.md).
