...
1. **Scegli zona e settore.** La concorrenza locale alza o abbassa prezzi di vendita e costi d'acquisto; l'affitto mensile dipende dalla regione.
...
- **Mercato:** rivali e affitti sono un pack di gioco (`src/config/market.ts`), non dati ISTAT.
