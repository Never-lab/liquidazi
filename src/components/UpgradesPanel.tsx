...
export const UpgradesPanel = () => {
  ...
  return (
    <section className={styles.panel}>
      ...
      <p className={styles.muted}>
        Potenzia gli upgrade azienda: la maggior parte arriva al Lv3, il magazzino scorte al Lv4 (cap 14 mesi).
      </p>
      <ul className={styles.list}>
        {UPGRADE_LIST.map((u) => {
          const lv = upgradeLevel(levels, u.id);
          const maxLv = upgradeMaxLevel(u.id);
